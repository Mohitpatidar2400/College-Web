                ...
                <div class="tm-left-right-container">
                    ...
                    <div class="tm-blue-bg tm-left-column">                        
                        <div class="tm-logo-div text-xs-center">
                            ...
                            <h1 class="tm-site-name">Medicaps university</h1>
                        </div>
                        <nav class="tm-main-nav">
                            <ul class="tm-main-nav-ul">
                                <li class="tm-nav-item">
                                    <a href="studhome.jsp" class="tm-nav-item-link">Home</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="studentque.jsp" class="tm-nav-item-link">Questions</a>
                                </li>
                                <li class="tm-nav-item">
                                    <a href="changepassword.jsp" class="tm-nav-item-link">Change Password</a>
                                </li>
                                
                                <li class="tm-nav-item">
                                    <a href="logout" class="tm-nav-item-link">Logout</a>
                                </li>
                            </ul>
                        </nav>                                         
